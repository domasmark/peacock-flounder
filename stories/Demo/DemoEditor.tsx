...
const layers = [
 ...
 const changes = [
   { label: 'From Design to Cod...', date: 'Just now' },
   { label: 'The Discovery of Ch...', date: '2 hour ago' },
   { label: 'As a designer, Sarah...', date: 'Yesterday' },
   { label: 'Draft file created', date: 'January 20, 2023' },
];
...
const textContent = (
   <>
      ...
      <Heading as='div' size='medium' secondary>Learning to Build a Web Component Library with Chat GPT.</Heading>
      <Text as='p' className=' mt-10'>As a designer, Sarah had always been comfortable working in design software like Adobe Photoshop and Sketch. However, she had always struggled with coding. Whenever she had to code a design into a website, she would get frustrated and overwhelmed. Sarah knew that being able to code was a valuable skill, but she just couldn't seem to grasp it. That was until she discovered Chat GPT.</Text>
      <Heading as='h2' size='large' className='mt-10' >The Discovery of Chat GPT</Heading>
      <Text as='p' className=' mt-2'>One day, while browsing the internet for solutions to her coding problems, Sarah stumbled upon Chat GPT. She was amazed at how easy it was to communicate with the AI-powered language model. Sarah began to ask Chat GPT questions about coding, and the responses were always informative and easy to understand. With Chat GPT's help, Sarah started to make progress with coding.</Text>
      <Heading as='h2' size='large' className='mt-10' >Building a Web Component Library</Heading>
      <Text as='p' className=' mt-2'>With Chat GPT as her coding mentor, Sarah was able to learn how to build a web component library. She used her design skills to create visually stunning components, and then used Chat GPT's coding knowledge to bring them to life. Sarah was ecstatic when she saw her designs come to life on a webpage. Thanks to Chat GPT, Sarah was able to overcome her coding frustrations and take her design skills to the next level.</Text>
   </>
);
...
const Header = () => {
   ...
   return (
      <Stack area='topbar' as="header" alignItems="center" variant="card" border={{bottom:true}} wFull padding='small'>
         <Button variant='light' icon={<IconArrowLeft/>}  label='Back to All Posts'/>
         ...
         <Button variant="light" labelPlacement='start' label="Manage"  icon={<IconChevronDown/>} />
         <Button variant="strong" labelPlacement='end' label="Publish" />
      </Stack>
   );
};
